...
export function StepperBar() {
  ...
  // Клик по кружку — активируем степпер + ставим шаг
      ...
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800 px-6 py-2 z-40">
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-blue-600 hover:bg-blue-50 rounded-md transition-colors"
          >
